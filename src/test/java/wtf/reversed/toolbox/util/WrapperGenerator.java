...
final class WrapperGenerator {
    public static final ClassName CHECK_CLASS = ClassName.get("wtf.reversed.toolbox.util", "Check");
    public static final ClassName ARRAYS_CLASS = ClassName.get("wtf.reversed.toolbox.util", "Arrays");
    public static final ClassName ARRAY_UTILS_CLASS = ClassName.get("wtf.reversed.toolbox.util", "ArrayUtils");
    ...
    private static void addOverrideMethods(
        ...
        builder.addMethod(override("compareTo")
            ...
            .addStatement("return $T.compare(array, fromIndex, toIndex, o.array, o.fromIndex, o.toIndex)", java.util.Arrays.class)
            .build());
        ...
        builder.addMethod(override("equals")
            ...
            .addStatement("return obj instanceof $L o && $T.equals(array, fromIndex, toIndex, o.array, o.fromIndex, o.toIndex)", className, java.util.Arrays.class)
            .build());
    ...
    private static void generateGet(TypeSpec.Builder classBuilder, Class<?> primitive, String upper, String size) {
        classBuilder.addMethod(MethodSpec.methodBuilder("get" + upper)
            ...
            .addStatement("return $T.get$L(array, fromIndex + offset, $T.LITTLE_ENDIAN)", ARRAYS_CLASS, upper, ByteOrder.class)
            .build());
    }

    private static void generateUnsignedGet(TypeSpec.Builder classBuilder, Class<?> primitive, String upper, String conv) {
    ...
    private static TypeSpec createMutableWrapperClass(
        ...
        // Add extra methods for MutableBytes
        if (addExtraMethods) {
    ...
    private static void writeClass(TypeSpec typeSpec) throws IOException {
        JavaFile
            .builder("wtf.reversed.toolbox.collect", typeSpec)
            .indent("    ")
            .build()
